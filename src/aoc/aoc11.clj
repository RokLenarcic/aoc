...
(defn parse-input [s] (mapv #(into {:inspections 0} %) (inputs/blocks s :item-fn parse-monkey)))

(def input (parse-input (slurp "/Users/roklenarcic/aoc/aoc11.txt")))
